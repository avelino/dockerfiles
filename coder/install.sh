...
; do \
    gpg --always-trust --yes --keyserver keyserver.ubuntu.com --recv-keys "$key" ; \
    gpg --always-trust --yes --keyserver pool.sks-keyservers.net --recv-keys "$key" || \
    gpg --always-trust --yes --keyserver pgp.mit.edu --recv-keys "$key" || \
    gpg --always-trust --yes --keyserver keyserver.pgp.com --recv-keys "$key" || \
    gpg --always-trust --yes --keyserver ha.pool.sks-keyservers.net --recv-keys "$key" ; \
done
